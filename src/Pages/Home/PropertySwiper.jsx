        ...
        <div className="w-full py-10 px-4 h-[90vh]">
            ...
            <CustomSwiper paginationId="property-swiper-pagination">
                ...
                <SwiperSlide key={property.id}>
                    <Card shadow="sm" padding="lg" radius="md" withBorder className="rounded-2xl overflow-hidden border border-gray-300">
                    ...
                    <div className="mt-4 space-y-2 px-5 pb-2">
                        ...
                        <Group className='flex items-center justify-between border-b py-4'>
